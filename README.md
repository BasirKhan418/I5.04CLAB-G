...
ESP32 firmware and wiring: [docs/esp32-door.md](docs/esp32-door.md). Lock-only sketch: `firmware/esp32-cam-door/esp32-cam-door.ino`. There is no door camera.
...
Firmware detail: [docs/esp32-door.md](docs/esp32-door.md). Canonical sketch: `firmware/esp32-cam-door/esp32-cam-door.ino` (lock only, no camera).
...
| `/dashboard` | Signed in | Who’s in, pending visitors (admin), door online |
